...
from src.utils import ChunkRecord, get_chroma_client, get_embedding_adapter, save_chunk_records
...
def load_markdown_documents(docs_dir: Path = COMPANY_DOCS_DIR) -> list[MarkdownDocument]:
...
def index_documents(embedding_backend: str | None = None) -> dict[str, int]:
	...
	config = {"configurable": {"embedding_backend": embedding_backend}} if embedding_backend else None
